...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, text="Kanye Quote GoesERE", width=250, font=("Arial", 20, "italic"), fill=THEME_COLOR)
        self.canvas.grid(row=1, column=0, columnspan=2, pady=50)

        true_img = PhotoImage(file="C:/Users/magda/PycharmProjects/quizzler-app-start/images/true.png")
        self.true_button = Button(image=true_img, highlightthickness=0, command=self.true_button_clicked)
        self.true_button.grid(row=2, column=0)

        false_img = PhotoImage(file="C:/Users/magda/PycharmProjects/quizzler-app-start/images/false.png")
